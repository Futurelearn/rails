...
class CircularDependenceTest < ActiveRecord::TestCase
  ...
  def test_circular_depenence_when_destroying_item_with_belongs_to_association
  ...
  def test_circular_depenence_when_destroying_item_with_has_one_association
